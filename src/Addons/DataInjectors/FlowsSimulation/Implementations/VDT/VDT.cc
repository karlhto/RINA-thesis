...
// Voice parameters initialization
    ...
    V_PDUSize_min = par("V_PDUSize_min").intValue();
    V_PDUSize_max = par("V_PDUSize_max").intValue();
...
// Data request parameters initialization
    ...
    D_Request_PDUSize = par("D_Request_PDUSize").intValue();
    D_Data_PDUSize = par("D_Data_PDUSize").intValue();
...
// Transfer parameters initialization
    ...
    T_Request_PDUSize = par("T_Request_PDUSize").intValue();
    T_Data_PDUSize = par("T_Data_PDUSize").intValue();
    T_AVG_FlowRate = par("T_AVG_FlowRate").doubleValue()*1000.0/8.0;
    T_WINDOW_MAX = par("T_WINDOW_MAX").intValue();
    T_WINDOW_UPDATE = par("T_WINDOW_UPDATE").intValue();
